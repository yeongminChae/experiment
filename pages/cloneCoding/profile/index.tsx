      ...
      <div className="ml-3 mt-2 w-full ">
        ...
        <div className="mb-3 mt-6 h-16 w-36 cursor-pointer rounded-full ">
          <div className="flex h-[7.5rem] w-36 items-center justify-around">
            ...
            <div className="ml-[18.5rem] mb-10 mr-20 flex h-28 w-28 items-center justify-between">
              <div className="mx-12 flex w-1 flex-col items-center justify-center">
                <span className="font-bold opacity-80 ">9</span>
          ...
          <div className="w-full">
            <span className="-mt-8 ml-1 mr-2 flex text-sm ">채영민</span>
            <span className="mt-[0.5] ml-1 mr-2 flex w-44 text-[0.5rem] opacity-60 ">
          ...
          <div className="mt-2 flex w-[92vw] items-start justify-end ">
            ...
            <motion.div
              ...
              className="ml-1 -mr-5 flex h-8 w-10 items-center justify-center rounded-md bg-slate-400/25"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <div className="mt-3 -ml-2 flex h-auto w-[97vw] items-center justify-around ">
            <div className="h-11 w-11 rounded-full border border-zinc-200 bg-white ring-2 ring-zinc-300 ring-offset-2 ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                // fill="#FCE700"
          ...
          <div className="mt-2 grid h-10 w-[100vw] grid-cols-2 ">
            <motion.div
              className={cls(
                ...
                tab === "menu"
                  ? "border-gray-400 duration-300 ease-out"
          ...
          {tab === "menu" ? (
            <div className="-ml-3 mt-[0.01rem] flex w-[31rem] border-t transition-colors duration-200 ease-in-out">
              <div className="grid h-[60vh] w-full grid-flow-row grid-cols-3 grid-rows-3 ">
                ...
                <div className="mt-[0.01rem] mr-[0.01rem] bg-violet-300">4</div>
                <div className="mt-[0.01rem] bg-violet-300">5</div>
                <div className="mt-[0.01rem] ml-[0.01rem] bg-violet-300">6</div>
                <div className="mt-[0.01rem] mr-[0.01rem] bg-violet-300">7</div>
                <div className="mt-[0.01rem] mr-[0.01rem] bg-violet-300">8</div>
                <div className="mt-[0.01rem] ml-[0.01rem] bg-violet-300">9</div>
              </div>
            </div>
          ) : null}
          {tab === "bio" ? (
            <div className="-ml-3 mt-[0.01rem] flex w-[31rem] border-t transition-colors duration-200 ease-in-out">
              <div className="grid h-[60vh] w-full grid-flow-row grid-cols-3 grid-rows-3 ">
                ...
                <div className="mt-[0.01rem] mr-[0.01rem] bg-violet-100">4</div>
                <div className="mt-[0.01rem] bg-violet-100">5</div>
                <div className="mt-[0.01rem] ml-[0.01rem] bg-violet-100">6</div>
                <div className="mt-[0.01rem] mr-[0.01rem] bg-violet-100">7</div>
                <div className="mt-[0.01rem] mr-[0.01rem] bg-violet-100">8</div>
                <div className="mt-[0.01rem] ml-[0.01rem] bg-violet-100">9</div>
              </div>
            </div>
          ) : null}
          <div className="sticky bottom-0 -ml-3 flex h-14 w-[31rem] items-center justify-around bg-white ">
            <div className="flex flex-col items-center">
              ...
              <div className="h-1 w-1 rounded-full bg-red-700 shadow-xl" />
            </div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <motion.div className="h-7 w-7 rounded-full border border-black">
              <Image
                src={Me}
                alt="profile"
                width={30}
