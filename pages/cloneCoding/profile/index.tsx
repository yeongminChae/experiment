...
const Profile: NextPage = () => {
  ...
  // const toggleDark = () => setIsDarkClicked((current) => !current);
  console.log(isDarkClicked);
  return (
    mounted && (
      <div
        className={cls("h-full w-full", isDarkClicked === true ? "dark" : "")}
      >
        <div className="ml-3 mt-2 w-full">
          <div className="mt-2 ml-3 mr-3 flex items-center justify-between dark:bg-black/10">
            ...
            {tab === "menu" ? (
              <div className="-ml-3 mt-[0.01rem] flex w-[31rem] border-t transition-colors duration-200 ease-in-out">
                <div className="grid h-[60vh] w-full grid-flow-row grid-cols-3 grid-rows-3 ">
                  ...
                  <div className="mt-[0.01rem] mr-[0.01rem] bg-violet-300">
                    4
                  </div>
                  <div className="mt-[0.01rem] bg-violet-300">5</div>
                  <div className="mt-[0.01rem] ml-[0.01rem] bg-violet-300">
                    6
                  </div>
                  <div className="mt-[0.01rem] mr-[0.01rem] bg-violet-300">
                    7
            ...
            {tab === "bio" ? (
              <div className="-ml-3 mt-[0.01rem] flex w-[31rem] border-t transition-colors duration-200 ease-in-out">
                <div className="grid h-[60vh] w-full grid-flow-row grid-cols-3 grid-rows-3 ">
                  ...
                  <div className="mt-[0.01rem] mr-[0.01rem] bg-violet-100">
                    4
                  </div>
                  <div className="mt-[0.01rem] bg-violet-100">5</div>
                  <div className="mt-[0.01rem] ml-[0.01rem] bg-violet-100">
                    6
                  </div>
                  <div className="mt-[0.01rem] mr-[0.01rem] bg-violet-100">
                    7
