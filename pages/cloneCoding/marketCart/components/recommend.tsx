...
const Recoomend = ({
  ...
  return (
    <div className="flex w-full flex-col rounded-2xl bg-white p-8 shadow-lg sm:row-span-1 sm:w-[30rem] md:w-[28.5rem] xl:col-span-1 xl:w-full ">
      ...
      <div className="flex flex-col">
        <span className="text-xl font-medium sm:my-1">{name} </span>
