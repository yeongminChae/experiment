      ...
      <div className="absolute mx-5 mt-8 w-full overflow-hidden">
        <div className="mt-1 flex items-center justify-between">
          ...
          <Link href={"./cloneCoding/profile"}>
            <div className="mb-3 mr-3 h-16 w-16 cursor-pointer rounded-full ">
              <Image
                src={Me}
                alt="profile"
                width={55}
        ...
        {/*  */}
        {/*  */}
        <div className="mr-[1.2rem] grid grid-flow-row ">
            ...
            <div className="mt-4 flex flex-col items-start justify-start">
              ...
              <div className="mx-5 mt-2 flex items-center justify-end">
                ...
                <div className="mx-3 flex items-center justify-start border-b-2 border-dashed ">
                  ...
                  <div className="sm:ml- mt-4 flex flex-col items-center justify-center ">
                    <motion.button
                      whileHover={{
              ...
              <div className="mx-5 flex items-center justify-end">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-transparent bg-white shadow-md ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    fill="#3AB0FF"
                ...
                <div className="mx-3 flex items-center justify-start border-b-2 border-dashed ">
                  <div className="flex flex-col items-start justify-center ">
                    <span className="">Twitter clone</span>
                    <span className="text-sm text-black opacity-50 ">
                      With ReactJs and Typescript, Backend : Firebase
                    </span>
                  </div>
                  <div className="mt-4 flex flex-col items-center justify-center ">
                    <motion.button
          ...
          <div className="mb-[4.5rem] h-[30rem] w-full ">
            <div className=" h-[25rem] w-full rounded-t-xl bg-gradient-to-r from-[#B9FFF8] to-[#C3FF99]">
              <div className="ml-5 flex flex-col ">
                <div className="absolute h-28 w-10 border-l-[20px] border-b-[30px] border-r-[20px] border-l-transparent border-b-[#B9FFF8] border-r-transparent bg-yellow-200  " />
                <div className="mt-20 grid h-auto w-96 grid-cols-2 ">
                  ...
                  <motion.svg
                    ...
                    className="ml-20 mt-6 h-24 w-24"
                  >
                ...
                <div className="flex items-start justify-start">
                  <span className="mt-5 w-56 text-[2rem] leading-[2.3rem] text-black/50 ">
                    Check, various coins here!
                  </span>
                </div>
              </div>
            </div>
            <div className="h-[5rem] w-full rounded-b-xl bg-[#FF9551] shadow-xl ">
              <div className="mx-5 flex items-center justify-start">
                ...
                <div className="absolute mx-16 flex items-center justify-start">
                  <div className="mt-3 flex flex-col items-start justify-between ">
                    <span className="text-[#F5F5F5] ">Bitcoin Tracker</span>
                    <span className="text-sm text-[#F5F5F5] opacity-70">
                      What is the Today&apos;s price
                    </span>
                  </div>
                  <div className="ml-16 -mr-4 mt-10 flex flex-col items-center justify-center ">
